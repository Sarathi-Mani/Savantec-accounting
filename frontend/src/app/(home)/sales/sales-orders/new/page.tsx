...
export default function AddSalesOrderPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    terms: "Standard sales order terms and conditions apply.",
  });
  ...
  const calculateTotals = () => {
    ...
    const otherCharges = formData.chargesType === 'percentage' 
      ? subtotal * (formData.otherCharges / 100)
    ...
    const total = subtotal + totalTax + otherCharges - discountAll;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Submitting sales order:', { formData, items, totals });
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 dark:bg-gray-dark md:p-6">
      ...
      {/* Page Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-dark dark:text-white">Sales Order</h1>
        <p className="text-dark-6">Add / Update Sales Order</p>
      </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData({...formData, salesorderDate: e.target.value})}
                      className="w-full rounded-lg border border-stroke bg-transparent px-4 py-2.5 outline-none focus:border-primary dark:border-dark-3"
                      required
                    />
                  </div>
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <label htmlFor="sendMessage" className="ml-2 text-sm text-dark dark:text-white">
