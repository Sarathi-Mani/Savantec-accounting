        ...
        <div className="w-full bg-gray-50 dark:bg-gray-900">
            <div className="border-b border-gray-200 bg-white px-4 py-4 dark:border-gray-700 dark:bg-gray-800 sm:px-6">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Edit Purchase Order</h1>
                        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Update purchase order details and items</p>
                    </div>
                </div>
            </div>
