...
export default function EditEmployeePage() {
  ...
  const [formData, setFormData] = useState({
    ...
    monthly_conveyance: "",
    monthly_medical: "",
    salary_calculation_method: "ctc_breakup",
    pan: "",
    aadhaar: "",
    uan: "",
    pf_number: "",
  ...
  useEffect(() => {
    if (companyId && params.id) {
      loadEmployeeData(companyId, params.id as string);
    }
  }, [companyId, params.id]);
  ...
  const loadEmployeeData = async (companyId: string, employeeId: string) => {
    try {
      ...
      setFormData({
        ...
        children_details: employee.children_details || "",
        ...
        date_of_joining: employee.date_of_joining ? new Date(employee.date_of_joining).toISOString().split("T")[0] : new Date().toISOString().split("T")[0],
        work_state: employee.work_state || "",
        ctc: employee.ctc ? employee.ctc.toString() : "",
        monthly_basic: employee.monthly_basic ? employee.monthly_basic.toString() : "",
        monthly_hra: employee.monthly_hra ? employee.monthly_hra.toString() : "",
        monthly_special_allowance: employee.monthly_special_allowance ? employee.monthly_special_allowance.toString() : "",
        monthly_conveyance: employee.monthly_conveyance ? employee.monthly_conveyance.toString() : "",
        monthly_medical: employee.monthly_medical ? employee.monthly_medical.toString() : "",
        salary_calculation_method: employee.salary_calculation_method || "ctc_breakup",
        pan: employee.pan || "",
        ...
        esi_applicable: employee.esi_applicable ?? true,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await payrollApi.updateEmployee(companyId, params.id as string, data);
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">Update employee details</p>
        </div>
      </div>
