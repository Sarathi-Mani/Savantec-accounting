...
export default function VisitsPage() {
  ...
  }, [statusFilter, engineerFilter, customerFilter, validityFilter, fromDate, toDate]);
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
              Track and manage engineer visits
            </p>
          </div>
        ...
        <div className="flex flex-wrap gap-4">
          <div className="flex-1 min-w-[200px]">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search engineer, customer, enquiry..."
                value={search}
                onChange={(e) => setSearch(e.target.value)}
                onKeyPress={(e) => e.key === 'Enter' && fetchVisits()}
          ...
          <table className="w-full">
            <thead className="bg-gray-200 dark:bg-gray-700/50">
              <tr className="text-sm font-semibold text-gray-600 dark:text-gray-300">
                ...
                <th className="text-left px-6 py-3 whitespace-nowrap">Customer</th>
                <th className="text-left px-6 py-3 whitespace-nowrap">IN Time</th>
                <th className="text-left px-6 py-3 whitespace-nowrap">OUT Time</th>
                <th className="text-left px-6 py-3 whitespace-nowrap">Duration</th>
                    ...
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-gray-500 dark:text-gray-400 mb-4">
                        {statusFilter || engineerFilter ?
                          ...
                          "Start tracking your first visit."}
                      </p>
                    </div>
                  </td>
                </tr>
                ...
                visits.map((visit) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      ...
                      {visit.enquiry_number && (
                        <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                          Enquiry: {visit.enquiry_number}
                        </div>
                      )}
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <div className="text-gray-900 dark:text-white font-medium">
                        {visit.duration_minutes?.toFixed(1) || "-"} mins
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="flex flex-col gap-1">
                        <span
                          className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium ${
                            getStatusBadgeClass(visit.status, visit.is_valid, visit.has_fraud_flag)
                          }`}
                        >
                        ...
                        {!visit.is_valid && !visit.has_fraud_flag && (
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        <Link
                          href={`/sales-tracking/visits/${visit.id}`}
                        ...
                        <Link
                          href={`/sales-tracking/trips/${visit.trip_id}`}
                          className="p-1.5 rounded-md text-gray-400 hover:text-gray-600 hover:bg-gray-50 dark:hover:text-gray-300 dark:hover:bg-gray-700/50"
                          title="View Trip"
                        >
