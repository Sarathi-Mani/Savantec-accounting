...
export default function PaymentVoucherPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert("Error creating payment voucher");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <>
      <Breadcrumb pageName="Payment Voucher" />

      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
          <h3 className="font-medium text-black dark:text-white">Create Payment</h3>
        </div>
        <form data-ui="sf-form" onSubmit={handleSubmit} className="p-6.5">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div>
              <label className="mb-2.5 block text-black dark:text-white">
                Pay From (Cash/Bank) <span className="text-meta-1">*</span>
              </label>
              <select
            ...
            <div>
              <label className="mb-2.5 block text-black dark:text-white">
                Pay To (Party/Expense) <span className="text-meta-1">*</span>
              </label>
              <select
