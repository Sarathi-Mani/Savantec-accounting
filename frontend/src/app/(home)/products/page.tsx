  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingProduct) {
        ...
        await productsApi.update(company.id, editingProduct.id, formDataToSend);
      } else {
        // Create new product
  ...
  return (
    <div>
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          onClick={() => router.push('/products/new')}  // ✅ Change this
      ...
      {showForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="max-h-[90vh] w-full max-w-4xl overflow-y-auto rounded-lg bg-white dark:bg-gray-dark">
            <div className="sticky top-0 flex items-center justify-between border-b border-stroke bg-white px-6 py-4 dark:border-dark-3 dark:bg-gray-dark">
            ...
            <form onSubmit={handleFormSubmit} className="p-6">
              <div className="grid gap-6">
                ...
                <div className="rounded-lg border border-stroke p-6 dark:border-dark-3">
                  <h3 className="mb-4 text-lg font-semibold text-dark dark:text-white">Item Basic Details</h3>
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                      <label className="mb-2 block text-sm font-medium text-dark dark:text-white">Item Name *</label>
                      <input
                        type="text"
                        name="name"
                        value={formData.name}
                ...
                <div className="rounded-lg border border-stroke p-6 dark:border-dark-3">
                  <h3 className="mb-4 text-lg font-semibold text-dark dark:text-white">💰 Pricing Information</h3>
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                      <label className="mb-2 block text-sm font-medium text-dark dark:text-white">Price *</label>
                      <input
                        type="number"
                        name="price"
                    ...
                    <div>
                      <label className="mb-2 block text-sm font-medium text-dark dark:text-white">Tax %</label>
                      <input
                        type="number"
                        name="gst_rate"
                ...
                {/* Purchase Price Calculation Section */}
                <div className="rounded-lg border border-stroke p-6 dark:border-dark-3">
                  <h3 className="mb-4 text-lg font-semibold text-dark dark:text-white">🧮 Purchase Price Calculation</h3>
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                ...
                {/* Sales & Profit Calculation Section */}
                <div className="rounded-lg border border-stroke p-6 dark:border-dark-3">
                  <h3 className="mb-4 text-lg font-semibold text-dark dark:text-white">📊 Sales & Profit Calculation</h3>
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                ...
                {/* Images Section */}
                <div className="rounded-lg border border-stroke p-6 dark:border-dark-3">
                  <h3 className="mb-4 text-lg font-semibold text-dark dark:text-white">🖼 Images</h3>
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-lg border border-stroke bg-transparent px-4 py-2.5 outline-none focus:border-primary dark:border-dark-3"
                      />
                      <p className="mt-1 text-xs text-dark-6">Max Width/Height: 1000px & Size: 1MB</p>
                    </div>
                    <div>
              ...
              <div className="mt-6 flex justify-end gap-4">
                <button
                  type="button"
                  onClick={() => setShowForm(false)}
                  className="rounded-lg border border-stroke px-6 py-3 font-medium text-dark transition hover:bg-gray-50 dark:border-dark-3 dark:text-white dark:hover:bg-dark-3"
                >
                  Cancel
                </button>
                <button
